...
if __name__ == "__main__":
    # as time permits, keep traning and blending
    num_limit = 1000
    cur_num_models = 0
    ...
    for i in range(num_limit):
        ...
        if i == 0:
            cumulative_predictions = ret
        else:
            cumulative_predictions += ret

        sub = cumulative_predictions / cur_num_models
        sub.to_csv(f"./submissions/exp059_seed_avg_{cur_num_models}_sub.csv", index=False)